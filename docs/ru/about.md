...
1. Обратитесь к владельцу бюджета (своему руководителю) — он должен добавить вас в систему.
...
После авторизации автоматически происходит **переход к главной или стартовой странице.** 
...
3. область с информацией о бюджете (справа).

![_modules_about](_images/start_page_account_zone.png){.center width=1200}

Из **меню** можно перейти в
- справочнику номенклатуры — содержит информацию о товарах, хранящихся на стоке: логистические фото, характеристики упаковки и другие параметры;
- списку заявок — все созданные вами заявки;
