...
В виде карточек **справа располагается информация о поручениях**: 1 карточка = 1 поручение.
Поручения привязаны к брендам, с которыми вы работаете, или отделу, сотрудником которого вы являетесь. Поручения других отделов или брендов увидеть не получится.  

![_modules_about](_images/list_of_poruch.png){.center width=1200}

**В карточке поручения отражена информация о:** 
1. номере поручения;
...
В **рабочей области располагается список заявок**, которые вы оформили. Требуемую заявку можно найти с помощью поиска по номеру заявки, а также отфильтровать по статусу заявки или дате создания. 

![_modules_about](_images/list_tasks.png){.center width=1200}

Информация по заявкам также распределена в виде карточек, где отображена информация о:
