...
**Подсистема «Товары» отображает актуальные складские остатки** по всем номенклатурам, которые в данный момент хранятся на складе.
...
Вы можете настроить отображение списка, выбрав один из вариантов группировки в правом верхнем углу страницы:
- по партиям — товары группируются по партиям, в рамках которых они поставлялись;
- по наименованию — товары с одинаковым наименованием объединяются в группы;
- поштучно — отображение без группировки, полный список позиций.
