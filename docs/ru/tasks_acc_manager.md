...
Подсистема «Заявки» содержит **список всех ранее созданных заявок** — как и на главной странице. Механизм отображения списка и поиска по заявкам также идентичен. 
Кроме того, и с главной страницы, и со страницы заявок **можно создать заявку** по команде «Создать заявку».
