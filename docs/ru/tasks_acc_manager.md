...
**Подсистема «Заявки» содержит список всех ранее созданных заявок.** По составу он аналогичен списку на главной странице, но функциональность здесь шире: доступны дополнительные действия и фильтры.
